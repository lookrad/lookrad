  ...
  public function controls() {
    ...
    $this->addControl(
      ...
      array(
        'columns' => '2',
        'choices' => array(
          array( 'value' => 'flip-from-bottom', 'label' => __( 'From Top', csl18n() ),    'icon' => fa_entity( 'arrow-up' ) ),
          array( 'value' => 'flip-from-left',   'label' => __( 'From Right', csl18n() ),  'icon' => fa_entity( 'arrow-right' ) ),
          array( 'value' => 'flip-from-top',    'label' => __( 'From Bottom', csl18n() ), 'icon' => fa_entity( 'arrow-down' ) ),
          array( 'value' => 'flip-from-right',  'label' => __( 'From Left', csl18n() ),   'icon' => fa_entity( 'arrow-left' ) )
        )
      )
    );
