...
class Cornerstone_Builder {
	...
	public function enqueueStyles() {
		...
		wp_enqueue_style( 'cs-styles', CS()->url() . 'assets/css/admin/builder.css', array( 'open-sans', 'cs-lato' ), CS()->version() );
	...
	public function primeEditor() {
		...
		ob_start();
		wp_editor( '','cswpeditor', array(
			//'quicktags' => false,
			'tinymce'=> array(
       	'toolbar1'=> 'bold,italic,strikethrough,underline,bullist,numlist,forecolor',
