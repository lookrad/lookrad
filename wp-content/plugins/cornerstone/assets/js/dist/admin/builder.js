...
var App = Mn.Application.extend({
  ...
  initialize: function() {
    ...
    this.Icons = (this.Config.isPreview == "true") ? top.cs.Icons : require('../tmp/templates-icons.js');
  ...
  icon: function () {
    ...
    return (this.Icons[ key ]) ? this.Icons[ key ]() : '<i class="cs-icon fallback" data-cs-icon="' + this.fontIcon() + '"><!-- icon '+ key +' not found--></i>';
  },
...
},{"../tmp/templates-builder.js":129,"../tmp/templates-elements.js":130,"../tmp/templates-icons.js":131,"./behaviors":4,"./data/models":18,"./data/models/collection-index":9,"./data/models/element-base":14,"./data/models/sortable-collection":28,"./modules/editor":29,"./modules/preview":30,"./utility/custom-media-manager":32,"./utility/messenger":33,"./utility/render-queue":34,"./utility/renderer":35,"./views/controls":51,"./views/controls/base":37,"./views/elements":96,"./views/elements/base":82}],2:[function(require,module,exports){
...
},{"./confirm":3,"./confirm-warn":2}],5:[function(require,module,exports){
/**
 ...
 */
require('./app')();
},{"../vendor/color":132,"../vendor/html.sortable":133,"../vendor/jquery.growl":134,"../vendor/pointer-events-polyfill":135,"../vendor/rgbaster":136,"../vendor/string_score":137,"./app":1,"backbone.marionette":139,"backbone.radio":140,"backbone.stickit":141,"moment":143,"nprogress":144,"perfect-scrollbar/jquery":145}],6:[function(require,module,exports){
...
},{"../data/models/block-collection":6,"../data/models/block-manager":7,"../data/models/control-collection":12,"../data/models/element-stub-collection":15,"../data/models/options":19,"../data/models/post":20,"../data/models/setting-section-collection":26,"../utility/ajax.js":31,"../views/main/editor":121}],30:[function(require,module,exports){
...
},{"../views/main/preview.js":125}],31:[function(require,module,exports){
module.exports = {
...
},{"./template-helpers":36}],36:[function(require,module,exports){
var TemplateHelpers = {
	/**
...
module.exports = cs.ControlViews.Base.extend({
	...
	onProxyReady: function() {
		this.editorID = 'cswpeditosr' + this.cid;
		...
		tinyMCEPreInit.mceInit[	this.editorID ].setup = _.bind(function(editor) {
			this.triggerMethod('tinymce:setup', editor );
    }, this );

    this.markup = cs.config.request('editor').replace(new RegExp('cswpeditor', 'g'), this.editorID );

	},

	onRender: function() {

		// Swap out textarea with uninitialized editor markup
		this.$('textarea').before( this.markup ).remove();;

		// This class allows us to reduce "flicker" by hiding the editor
		// until we are done loading and modifying it.
		this.$el.addClass('cs-loading-editor');
		...
		// Wait a cycle before initialized the editor modes. This ensures the DOM is ready.
		_.defer( _.bind( this.initEditors, this ) );
	...
	initEditors: function() {
		try {
			...
			// Initialize tinyMCE and QuickTags with cloned settings
			tinymce.init( tinyMCEPreInit.mceInit[	this.editorID ] );
			quicktags( tinyMCEPreInit.qtInit[this.editorID] );

			// Remove default instance after QuickTags initializes
			// This allows us to reinitialize things an unlimited amount of times.
			_.defer(function(){
				delete QTags.instances[0];
			});

			// Instantiate tinyMCE and attach to DOM
			// This will eventually trigger onTinymceSetup
			tinymce.EditorManager.execCommand('mceAddEditor',true, this.editorID );
	...
	onTinymceSetup: function( editor ) {
		...
		editor.on( 'keyup change', _.bind( function() {
			this.proxy.set( this.model.get('name'), editor.getContent() );
		}, this ) );

		// Wait until TinyMCE is fully loaded
		editor.on( 'init', _.bind( function() {

			// Switch to "Text mode" so it is shown first.
			switchEditors.go( this.editorID, 'html');

			// Remove the loading class to make the editor appear
			this.$el.removeClass('cs-loading-editor');
		...
		if ( ! window.wpActiveEditor ) {
			window.wpActiveEditor = this.editorID;
		}

	},

	onDestroy: function() {
		// cleanup tinyMCE and QuickTags instances
...
},{"./breadcrumbs":38,"./choose":39,"./code-editor":40,"./color":41,"./column-actions":42,"./custom-markup":44,"./dimensions":45,"./editor":46,"./element-actions":47,"./element-info":48,"./icon-choose":49,"./image":50,"./layout/column-layout":52,"./layout/column-order":54,"./layout/layout-actions":55,"./layout/sortable-columns":56,"./layout/sortable-rows":58,"./layout/sortable-sections":59,"./layout/template-actions":60,"./layout/template-remove":61,"./layout/template-save-dialog":62,"./layout/template-select":63,"./layout/template-upload-dialog":64,"./multi-choose":65,"./number":66,"./row-actions":67,"./section-actions":68,"./select":69,"./settings-actions":70,"./sortable":73,"./text":74,"./textarea":75,"./title":76,"./toggle":77,"./wpselect":78}],52:[function(require,module,exports){
...
},{"../../../data/models/row-validator":22}],53:[function(require,module,exports){
module.exports = Mn.ItemView.extend({
	tagName: 'li',
...
},{"../sortable":73,"./column-order-item":53}],55:[function(require,module,exports){
module.exports = Mn.ItemView.extend({
	tagName: 'li',
  className: 'cs-control cs-control-actions cs-control-divider',
...
},{"../sortable":73}],57:[function(require,module,exports){
...
},{"../sortable-item-wide":71}],58:[function(require,module,exports){
var Sortable = require('../sortable');
module.exports = Sortable.extend({
...
},{"../sortable":73,"./sortable-item-rows":57}],59:[function(require,module,exports){
var Sortable = require('../sortable');
module.exports = Sortable.extend({
...
},{"../sortable":73}],60:[function(require,module,exports){
module.exports = Mn.ItemView.extend({
	tagName: 'li',
...
},{"./sortable-item":72}],72:[function(require,module,exports){
module.exports = Mn.ItemView.extend({
...
},{"./sortable-item":72,"./sortable-item-wide":71}],74:[function(require,module,exports){
module.exports = cs.ControlViews.Base.extend({
	controlName: 'text',
	bindingSelector: 'input[type=text]',
	controlEvents: {
...
module.exports.BaseCore = Mn.CollectionView.extend( {
	template: 'base',
...
module.exports.Base = Mn.CompositeView.extend(  {
	template: 'base',
	className: 'cs-preview-element-wrapper',
	attributes: {
		'draggable': 'true'
...
},{"./accordion":79,"./alert":80,"./author":81,"./blockquote":83,"./button":84,"./callout":85,"./card":86,"./code":87,"./column":88,"./columnize":89,"./counter":90,"./creative-cta":91,"./custom-headline":92,"./feature-headline":93,"./gap":94,"./google-map":95,"./promo":97,"./prompt":98,"./pullquote":99,"./row":100,"./skill-bar":102,"./social-sharing":103,"./tabs":104,"./text":106,"./text-type":105}],97:[function(require,module,exports){
module.exports = cs.ElementViews.Base.extend({
	autoFocus: {
...
},{"./column":88}],101:[function(require,module,exports){
module.exports = cs.ElementViews.BaseCore.extend( {
...
},{"./row":100}],102:[function(require,module,exports){
module.exports = cs.ElementViews.Base.extend({
	autoFocus: {
		'.h-skill-bar': 'heading',
...
},{"../../data/models/control-collection":12}],111:[function(require,module,exports){
// Respond
module.exports = Mn.ItemView.extend({
...
},{"../controls/control-collection":43}],114:[function(require,module,exports){
// LayoutPane
...
},{"../controls/control-collection":43,"./sub-row/layout-sub-rows":115,"./sub-templates/layout-sub-templates":116}],115:[function(require,module,exports){
// RowSubPane
...
},{"../../../data/models/control-collection":12,"../../controls/control-collection":43}],116:[function(require,module,exports){
// TemplatesSubPane
...
},{"../../../data/models/control-collection":12,"../../controls/control-collection":43}],117:[function(require,module,exports){
// ElementLibraryPane
...
},{"../main/base-pane":120,"./library-list":119}],118:[function(require,module,exports){
// ElementLibraryItem
...
},{"./element-stub":118}],120:[function(require,module,exports){
// BasePane
...
},{"../inspector/inspector":113,"../layout/layout":114,"../library/element-library":117,"../settings/settings":128,"./footer":122,"./header":123}],122:[function(require,module,exports){
...
},{"../extra/confirm":107,"../extra/expand":108,"../extra/home":109,"../extra/options":110,"../extra/respond":111,"../extra/save-complete":112}],123:[function(require,module,exports){
// EditorHeader
module.exports = Mn.ItemView.extend({
  tagName: 'nav',
...
},{"../elements/section":101,"./observer.js":124}],126:[function(require,module,exports){
module.exports = Mn.CollectionView.extend({
...
},{"./settings-section":127}],127:[function(require,module,exports){
module.exports = Mn.CompositeView.extend({
...
},{"../../data/models/control-collection":12,"../controls/control-collection":43,"../main/base-pane":120,"./settings-collection":126}],129:[function(require,module,exports){
...
var templates={};templates['base']=function (obj) {
obj || (obj = {});
var __t, __p = '', __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
return __p
};templates['dragging-placeholder']=function (obj) {
obj || (obj = {});
var __t, __p = '';
with (obj) {
...
},{"backbone":"backbone","underscore":"underscore"}],139:[function(require,module,exports){
...
},{"backbone":"backbone","backbone.babysitter":138,"backbone.wreqr":142,"underscore":"underscore"}],140:[function(require,module,exports){
...
},{"backbone":"backbone","underscore":"underscore"}],141:[function(require,module,exports){
...
},{"./src/js/adaptor/jquery":146}],146:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../main":152,"../plugin/instances":163}],147:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"./class":147,"./dom":148}],152:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"./plugin/destroy":154,"./plugin/initialize":162,"./plugin/update":165}],153:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../lib/dom":148,"../lib/helper":151,"./instances":163}],155:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/helper":151,"../instances":163,"../update-geometry":164}],156:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/dom":148,"../../lib/helper":151,"../instances":163,"../update-geometry":164}],157:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/helper":151,"../instances":163,"../update-geometry":164}],158:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/helper":151,"../instances":163,"../update-geometry":164}],159:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../instances":163,"../update-geometry":164}],160:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/helper":151,"../instances":163,"../update-geometry":164}],161:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../instances":163,"../update-geometry":164}],162:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../lib/class":147,"../lib/helper":151,"./handler/click-rail":155,"./handler/drag-scrollbar":156,"./handler/keyboard":157,"./handler/mouse-wheel":158,"./handler/native-scroll":159,"./handler/selection":160,"./handler/touch":161,"./instances":163,"./update-geometry":164}],163:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../lib/dom":148,"../lib/event-manager":149,"../lib/guid":150,"../lib/helper":151,"./default-setting":153}],164:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../lib/class":147,"../lib/dom":148,"../lib/helper":151,"./instances":163}],165:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../lib/dom":148,"../lib/helper":151,"./instances":163,"./update-geometry":164}],"backbone":[function(require,module,exports){
